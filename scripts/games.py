...
def preprocess():
    ...
    with open(text_path, 'r') as file_list:
        while True:
            ...
            if len(resampled_audio_sing) > max_len:
    ...
    #         print(line_sing)
    #         #print(stretching_factor)
    #         sf.write(full_stretch_resampled_path + line_sing[:-1], s_wav, s_fs)
    #         sf.write(full_stretch_resampled_path + line_read[:-1], r_wav, r_fs)
    #
...
def resample():
    ...
    args = sys.argv
    file = str(os.path.abspath(args[1]))
